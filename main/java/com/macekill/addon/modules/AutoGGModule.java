...
extends Module {
    ...
    public AutoGGModule() {
        ...
        this.messageList = this.sgGeneral.add(((StringListSetting.Builder)((StringListSetting.Builder)new StringListSetting.Builder().name("\u6d88\u606f\u5217\u8868")).description("\u51fb\u6740\u540e\u968f\u673a\u9009\u62e9\u4e00\u6761\u53d1\u9001\uff0c{player} \u5c06\u88ab\u66ff\u6362\u4e3a\u76ee\u6807\u73a9\u5bb6\u540d")).defaultValue(new String[]{"gg {player}", "ez {player}", "L + ratio {player}"}).build());
        this.range = this.sgGeneral.add(((DoubleSetting.Builder)((DoubleSetting.Builder)new DoubleSetting.Builder().name("\u68c0\u6d4b\u8303\u56f4")).description("\u9644\u8fd1\u73a9\u5bb6\u7684\u68c0\u6d4b\u8ddd\u79bb\uff08\u683c\uff09")).defaultValue(16.0).min(1.0).max(128.0).sliderMax(64.0).build());
        this.chatPrefix = this.sgGeneral.add(((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)new StringSetting.Builder().name("\u804a\u5929\u524d\u7f00")).description("\u53d1\u9001\u804a\u5929\u6d88\u606f\u65f6\u5728\u524d\u9762\u81ea\u52a8\u63d2\u5165\u7684\u6587\u672c\uff08&\u4ee3\u8868\u00a7\u6362\u8272\u7b26\uff09")).defaultValue("&7[&bQazr&7]&r ")).build());
        this.chatSuffix = this.sgGeneral.add(((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)new StringSetting.Builder().name("\u804a\u5929\u540e\u7f00")).description("\u53d1\u9001\u804a\u5929\u6d88\u606f\u65f6\u5728\u540e\u9762\u81ea\u52a8\u63d2\u5165\u7684\u6587\u672c\uff08&\u4ee3\u8868\u00a7\u6362\u8272\u7b26\uff09")).defaultValue("")).build());
    ...
    private void updateNearbyPlayers() {
        ...
        for (PlayerEntity player : this.mc.world.getPlayers()) {
            if (player == this.mc.player || this.mc.player.squaredDistanceTo((Entity)player) > rangeSq) continue;
    ...
    private void onPacketSend(PacketEvent.Send event) {
        ...
        if (eventPacket instanceof ChatMessageC2SPacket) {
            ChatMessageC2SPacket chatPacket = (ChatMessageC2SPacket)eventPacket;
            ...
            event.cancel();
            this.mc.getNetworkHandler().sendChatMessage(modified);
    ...
    private void sendGGMessage(String playerName) {
        List messages = (List<String>)this.messageList.get();
        ...
        if (this.mc.inGameHud != null) {
            this.mc.inGameHud.setTitle((Text)Text.literal((String)("\u00a7c\u51fb\u6740 \u00a7e" + playerName)));
        }
        if (this.mc.player != null) {
            this.mc.player.sendMessage((Text)Text.literal((String)("\u00a7e[AutoGG] \u00a7a" + msg)), false);
        }
